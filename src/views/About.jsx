    ...
    return (
        <main className='w-full bg-black/90 px-8 md:px-10' id="about">
            <div className='max-w-[1500px] mx-auto relative flex justify-end py-32'>
                <img src="https://ik.imagekit.io/xzgmktvzg/Open_Logic/bulb.png?ik-sdk-version=javascript-1.4.3&updatedAt=1678431311661" alt="bulb" className="w-[15rem] lg:w-[20rem] absolute opacity-50 lg:opacity-100 left-[-10rem] lg:left-0 top-0 bottom-0 my-auto drop-shadow-bulbGlow z-20" />
